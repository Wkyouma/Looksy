    ...
    return (
        <>
            <div className="flex justify-center my-4 px-4">
                <input 
                    className="w-full max-w-2xl bg-gradient-to-r from-blue-100 to-blue-200 hover:bg-blue-100 placeholder:text-gray-400 transition-all duration-300 rounded-xl h-10 text-center text-blue-500 focus:placeholder:text-cyan-600 border border-transparent focus:outline-none focus:ring-0 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-200"  
                    value={text} 
